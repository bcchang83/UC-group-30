...
from utils_weather_5 import ngsimDataset,maskedNLL,maskedMSETest,maskedNLLTest
...
# Evaluation metric:
metric = 'rmse'  #or rmse or nll


# Initialize network
net = highwayNet(args)
net.load_state_dict(torch.load('trained_models/cslstm_m_weather_5.tar'))
if args['use_cuda']:
    net = net.cuda()

tsSet = ngsimDataset('TestSet_weather_5.npy')
