...
from utils_weather import ngsimDataset,maskedNLL,maskedMSETest,maskedNLLTest
...
# Initialize network
net = highwayNet(args)
net.load_state_dict(torch.load('trained_models/weather_cslstm_m.tar'))
if args['use_cuda']:
    net = net.cuda()

tsSet = ngsimDataset('TestSet_weather.npy')
